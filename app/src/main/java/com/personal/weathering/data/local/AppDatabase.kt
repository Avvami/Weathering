        ...
        private val prepopulateCallback = object : Callback() {
            override fun onCreate(db: SupportSQLiteDatabase) {
                ...
                val defaultPreferences = ContentValues().apply {
                    put("cityId", 2643743)
                    put("selectedCity", "London")
                    put("selectedCityLat", 51.50853)
                    put("selectedCityLon", -0.12574)
                    put("useLocation", false)
                    put("currentLocationCity", "London")
                    put("currentLocationLat", 51.50853)
                    put("currentLocationLon", -0.12574)
